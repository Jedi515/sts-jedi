...
import jedi.relics.GhostBlades;

import static jedi.patches.JediEnums.JEDI_PIERCING_CARD;
import static jedi.patches.JediEnums.JEDI_PIERCING_DAMAGE;
...
public class GhostBladePatches
{
    ...
    public static class BetterShivs
    {
        ...
        {
            if (AbstractDungeon.player != null && AbstractDungeon.player.hasRelic(GhostBlades.ID))
            {
