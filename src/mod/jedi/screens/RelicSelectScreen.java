/*
* This code, in its entirety, was created by and thus belongs to papa kio aka kiooeht
* link source: https://github.com/kiooeht/Hubris/blob/master/src/main/java/com/evacipated/cardcrawl/mod/hubris/screens/select/RelicSelectScreen.java
* */

package mod.jedi.screens;
...
//    public static final String[] TEXT = uiStrings.TEXT;
    ...
    private void calculateScrollBounds()
    {
        ...
        if (size > 10) {
            ...
            scrollUpperBound = scrollLowerBound + Settings.DEFAULT_SCROLL_LIMIT + scrollTmp * 50.0f * Settings.scale;
        } else {
