...
import mod.jedi.interfaces.onCreateRewards;
...
public class ModifyRewardsPatch
{
    ...
    public static class PreRewardGeneration
    {
        ...
        public static void preRewards(AbstractRoom __instance, ArrayList<RewardItem> ___rewards)
        {
            ...
            {
                AbstractDungeon.player.relics.stream().filter(relic -> relic instanceof onCreateRewards).forEach(relic -> ((onCreateRewards) relic).beforeCreated(___rewards));
